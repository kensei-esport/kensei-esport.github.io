...
const translations = {
  fr: {
    ...
    nav_results_all:'Tous les résultats',
    ...
    section_upcoming:'Prochains matchs',
    ...
    palmares_title:          'Palmarès',
    palmares_label:          'Trophées',
    palmares_empty:          'Aucun palmarès pour le moment.',
    palmares_loading:        'Chargement du palmarès…',
    palmares_placement:      'Placement',
    palmares_prize:          'Prime',
    news_title:              'Actualités',
    news_label:              'Latest',
    news_empty:              'Aucune actualité pour le moment.',
    partners_empty:          'Aucun partenaire pour le moment.',
    upcoming_empty:          'Aucun match prévu pour le moment.',
    add_to_calendar:         'Ajouter au calendrier',
    player_no_bio:           'Pas encore de description.',
  },
  en: {
    nav_home:      'Home',
    nav_teams:     'Teams',
    ...
    palmares_title:          'Honours',
    palmares_label:          'Trophies',
    palmares_empty:          'No honours recorded yet.',
    palmares_loading:        'Loading honours…',
    palmares_placement:      'Placement',
    palmares_prize:          'Prize',
    news_title:              'News',
    news_label:              'Latest',
    news_empty:              'No news yet.',
    partners_empty:          'No partners yet.',
    upcoming_empty:          'No upcoming matches.',
    add_to_calendar:         'Add to calendar',
    player_no_bio:           'No bio yet.',
  }
};
